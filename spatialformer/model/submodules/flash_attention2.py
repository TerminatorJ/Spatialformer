...
from spatialformer.model.settings import Settings
...
class MHA(nn.Module):
    ...
    def __init__(
        ...
        if use_alibi:
            ...
            alibi_slopes = alibi_slopes.clone().expand(batch_size, -1).contiguous()
        ...
        **kwargs,
        ...
        if not self.cross_attn and self.num_heads_kv == self.num_heads:
            ...
            if not self.return_residual:
                # import pdb; pdb.set_trace()
                # print(f"The dtype of self.Wqkv is: {self.Wqkv.weight.dtype}")
                qkv = self.Wqkv(x)
