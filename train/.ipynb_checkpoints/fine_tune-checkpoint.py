...
sys.path.append("/home/sxr280/Spatialformer/model")
...
class FineTune:
    def __init__(self, config, ckp_path, sample_name, radius, fine_tune_mode, wandb, strategy, lora_ckp_path=None, output_dir=None):
        self.config = config
